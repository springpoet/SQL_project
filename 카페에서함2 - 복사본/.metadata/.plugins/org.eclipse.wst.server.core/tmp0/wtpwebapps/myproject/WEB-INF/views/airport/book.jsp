...
<%!String IMG_PATH2 = "";%>
	...
	<c:choose>
	  ...
	  <div class="row g-0" style="border:2px solid black; border-bottom:none;" style="height:100%" >
	    <div class="col-md-4" style=height:100%>
	     <img src="<%=IMG_PATH2%>" class="img-fluid rounded-start" alt="예?" style="height:280px;">
	    </div>
	    <div class="col-md-8">
	      <div class="card-body">
	        ...
	        <div style="display:flex;">
		       ...
		       <div style="margin-top:50px; margin-left:50px;">
		       		<img src="<%=IMG_PATH1%>" style="height:100px; width:350px; object-fit: fill;"/>
		       </div>
		      </div>
	         </p>
	      </div>
